...
public class ButtonGradient extends JButton {
    ...
    private Color color1 =new Color(66, 9, 9);
    ...
    public ButtonGradient() {
        try{setContentAreaFilled(false);
        setFocusPainted(false);
        setForeground(new Color(187, 129, 144));
    ...
    protected void paintComponent(Graphics grphcs) {
        try {
            ...
            System.out.println("paintComponent exception");
        }
    }

    private Color enteredColor1 = Color.gray;
    private Color enteredColor2 =new Color(255, 255, 255, 60);

    public void setEnteredColor1(Color enteredColor1) {
        this.enteredColor1 = enteredColor1;
    }

    public void setEnteredColor2(Color enteredColor2) {
        this.enteredColor2 = enteredColor2;
    }
    ...
    private void createStyle(Graphics2D g2) {
       try {
           ...
           int width = getWidth();
           int height = getHeight();
           GradientPaint gra = new GradientPaint(0, 0, enteredColor1, 0, height, enteredColor2);
           g2.setPaint(gra);
           ...
           System.out.println("Create style exception");
       }
    }
    ...
    private void paintPressed(Graphics2D g2) {
        try {
            ...
            System.out.println("PaintPressed exception");
        }
    }
}